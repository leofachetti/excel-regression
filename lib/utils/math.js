...
exports.residual = {
  ...
  predictedY: function(values) {
    var linearRegression = exports.linearRegression(values);
    var predictedY = [];

    _.pluck(linearRegression.points, 1).forEach(function(point) {
...
exports.anova = {
  intercept: {
    coefficient: function(values) {
      var linearRegression = exports.linearRegression(values);
      return _.round(linearRegression.equation[1], 5);
    }
  },
  ...
  varX1: {
    coefficient: function(values) {
      var linearRegression = exports.linearRegression(values);
      return _.round(linearRegression.equation[0], 5);
    }
  },
